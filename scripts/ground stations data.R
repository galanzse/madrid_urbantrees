...
# data from council ground stations since 2019 ####
...
# data from AEMET ground stations 2017 ####
...
for (s in 1:13) { data_aemet[[s]] <- data_aemet[[s]] %>% dplyr::select(fecha, indicativo, nombre, tmed, tmin, tmax) }
